...
namespace eShopSolution.AdminApp.Services
{
    public class UserApiClient : IUserApiClient
    {
        ...
        public async Task<ApiResult<bool>> Delete(Guid id)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                return JsonConvert.DeserializeObject<ApiSucessResult<bool>>(body);
            }
        ...
        public async Task<ApiResult<UserVm>> GetById(Guid id)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
               return JsonConvert.DeserializeObject<ApiSucessResult<UserVm>>(body);
            }
        ...
        public async Task<ApiResult<PagedResult<UserVm>>> GetUsersPagings(GetUserPagingRequest request)
        {
            ...
            var body = await response.Content.ReadAsStringAsync();
            var users = JsonConvert.DeserializeObject<ApiSucessResult<PagedResult<UserVm>>>(body);
            return users;
