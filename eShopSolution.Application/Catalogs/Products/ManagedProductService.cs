...
namespace eShopSolution.Application.Catalogs.Products
{
    public class ManagedProductService : IManagedProductService
    {
        ...
        public ManagedProductService(EShopDbContext context, IStorageService storageService)
        {
            _context = context;
        ...
        public Task<int> UpdatesImages(int imageId, string caption, bool isDefault)
        {
            throw new NotImplementedException();
        }
